    ...
    <aside
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white active bg-gradient-primary" href="/directeur/agents">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div class="container">
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($agents as $agent)
                                <tr>
                                    ...
                                    <td>{{ $agent->email }}</td>
                                    <td>
                                        <a href="{{ route('directeur.agents.transactions', $agent->id) }}"
                                            class="btn btn-primary">Voir Transactions</a>
                                        <form action="{{ route('directeur.agents.destroy', $agent->id) }}"
                    ...
                    <a href="{{ route('directeur.agents.create') }}" class="btn btn-secondary add-agent-link">Ajouter
                        un Agent</a>
                </div>
            </div>
        </div>
